...
function it(expectation: string, assertion?: (done: () => void) => void, timeout?: number): void;
function fit(expectation: string, assertion?: () => void, timeout?: number): void;
function fit(expectation: string, assertion?: (done: () => void) => void, timeout?: number): void;
function xit(expectation: string, assertion?: () => void, timeout?: number): void;
function xit(expectation: string, assertion?: (done: () => void) => void, timeout?: number): void;

/** If you call the function pending anywhere in the spec body, no matter the expectations, the spec will be marked pending. */
function pending(reason?: string): void;

function beforeEach(action: () => void, timeout?: number): void;
function beforeEach(action: (done: () => void) => void, timeout?: number): void;
function afterEach(action: () => void, timeout?: number): void;
function afterEach(action: (done: () => void) => void, timeout?: number): void;

function beforeAll(action: () => void, timeout?: number): void;
function beforeAll(action: (done: () => void) => void, timeout?: number): void;
function afterAll(action: () => void, timeout?: number): void;
function afterAll(action: (done: () => void) => void, timeout?: number): void;
